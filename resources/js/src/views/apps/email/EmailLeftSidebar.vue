...
export default {
  ...
  setup() {
    ...
    const emailFilters = [
      ...
      // { title: 'Trimise', icon: 'SendIcon', route: { name: 'apps-email-folder', params: { folder: 'sent' } } },
      // { title: 'Draft', icon: 'Edit2Icon', route: { name: 'apps-email-folder', params: { folder: 'draft' } } },
      // { title: 'Favorite', icon: 'StarIcon', route: { name: 'apps-email-folder', params: { folder: 'starred' } } },
      // { title: 'Spam', icon: 'InfoIcon', route: { name: 'apps-email-folder', params: { folder: 'spam' } } },
      // { title: 'Gunoi', icon: 'TrashIcon', route: { name: 'apps-email-folder', params: { folder: 'trash' } } },
    ]
