  ...
  <div>
      ...
      >
        <b-card-body class="text-center">
          ...
          <b-card-text class="mb-2">
              sau alegeți o categorie pentru a găsi rapid ajutorul de care aveți nevoie
          </b-card-text>
    ...
    <section class="faq-contact">
      <b-row class="mt-5 pt-75 text-center">
        <b-col cols="12">
          <h2>Mai ai o întrebare?</h2>
          <b-card-text class="mb-3">
              Dacă nu găsiți o întrebare în întrebările frecvente, ne puteți contacta oricând. Vă vom răspunde în scurt timp!
          </b-card-text>
        </b-col>
        <b-col sm="6">
          <b-card
          ...
          >
            ...
            <h4>+ (810) 2548 2568</h4>
            <span class="text-body">Suntem mereu bucuroși să ajutăm!</span>
          </b-card>
        </b-col>
        <b-col sm="6">
          <b-card
          ...
          >
            ...
            <span class="text-body">Cel mai bun mod de a primi un răspuns mai rapid!</span>
          </b-card>
        </b-col>
      </b-row>
    </section>
