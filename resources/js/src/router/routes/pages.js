export default [
  ...
  {
    path: '/thesis/list',
    name: 'pages-jobs-list',
    component: () => import('@/views/pages/blog/BlogList.vue'),
    meta: {
      pageTitle: 'Toate prezentările',
      breadcrumb: [
        {
          text: 'Acasa',
          active: true,
  ...
  {
    path: '/user/thesis/list',
    name: 'pages-my-jobs-list',
    component: () => import('@/views/pages/blog/MyBlogList.vue'),
    meta: {
      pageTitle: 'Prezentările mele',
      breadcrumb: [
        {
          text: 'Prezentările mele',
          active: true,
        },
      ],
    },
  ...
  {
    path: '/pages/thesis/edit/:id',
    name: 'pages-jobs-edit',
    component: () => import('@/views/pages/blog/BlogEdit.vue'),
    meta: {
      pageTitle: 'Publică prezentarea',
      breadcrumb: [
        {
          text: 'Publicare prezentare',
          active: true,
        },
      ],
    },
